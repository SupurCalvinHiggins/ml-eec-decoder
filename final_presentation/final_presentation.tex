...
%RNNs can remember its previous inputs but Standard Neural Networks are not capable of remembering previous inputs. RNN takes historical information for computation.
...
\textbf{LSTMs} are powerful RNN variant with longer term memory. Practically speaking, they are a drop-in replacement with a lot of kick!
...
%------------------------------------------------
\section{Comparison Against the Viterbi Decoder} % testing?
%------------------------------------------------
